...
function Signup(){
    ...
    const handleSubmit = (e) => {
        e.preventDefault(); // stop reload for SPA
      ...
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full">
              <button className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 
              ...
              <span className="inline-flex">
                ...
                <a className="ml-4 text-gray-500">
                  ...
                  >
                    ...
                    9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 
                ...
                <a className="ml-4 text-gray-500">
                  ...
                  >
                    ...
                    3.8 8.5 8.5 0 01-7.6 4.7 
                    8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 
                    8.38 0 01-.9-3.8 8.5 8.5 
                    0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 
                    8.48 0 018 8v.5z"></path>
                  </svg>
                </a>
              </span>
            </div>
